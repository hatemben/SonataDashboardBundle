    ...
    public function getConfigTreeBuilder()
    {
        ...
        $node
            ->arrayNode('class')
                ->addDefaultsIfNotSet()
                ->children()
                    ->scalarNode('dashboard')->defaultValue('Application\\Sonata\\DashboardBundle\\Document\\Dashboard')->end()
                    ->scalarNode('block')->defaultValue('Application\\Sonata\\DashboardBundle\\Document\\Block')->end()
                ->end()
            ->end()
